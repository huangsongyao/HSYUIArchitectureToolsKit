//
//  UIViewController+SystemShared.m
//  HSYMethodsToolsKit
//
...
@implementation UIViewController (SystemShared)

+ (UIActivityViewController *)defaultSystemShareViewController:(NSArray *)shareItems
                                         applicationActivities:(NSArray<UIActivity *> *)activitis
                                                shareCompleted:(RACSignal *(^)(BOOL shared, UIActivityType activityType, NSError *activityError))shareCompleted
{
...
- (void)hsy_systemShare:(NSArray *)shareItems
            shareResult:(RACSignal *(^)(BOOL shared, UIActivityType activityType, NSError *activityError))result
{
